...
test('When submit button is clicked the form closes', async () => {
...
// test('When another recipe is added a list all recipes are shown', async () => {
//   const {instructionsInput, nameInput, submitButton} = setup();
//   const recipeName = "Green Pockets"
//   const recipeInstructions = "place in toaster oven on 350 for 45 minutes or until ham"
//   const recipeList = [{recipeName, recipeInstructions}]

//   expect(screen.getByText(recipeList))
// })